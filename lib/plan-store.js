...
async function save(input) {
  ...
  const next = normalizePlan({ ...old, ...input, id, name, price, durationDays, trafficBytes, hwidLimit, active: input.active !== false, sortOrder: input.sortOrder ?? old?.sortOrder ?? plans.length });
