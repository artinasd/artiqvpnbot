const SERVICES = [
  ...
  { id: 'tunnel2', name: 'Tunnel 2', label: '🛡️ Tunnel 2', emoji: '🛡️', description: 'سرویس تونل دوم', order: 40, provider: 'pasarguard-tunnel2', defaultEnabled: false, defaultTestEnabled: false, defaultPurchaseEnabled: false },
];
