const SERVICES = [
  ...
  { id: 'direct2', name: 'Direct 2', label: '🎯 Direct 2', emoji: '🎯', description: 'سرویس Direct 2', order: 40, provider: 'pasarguard-direct2', defaultEnabled: false, defaultTestEnabled: false, defaultPurchaseEnabled: false },
];
